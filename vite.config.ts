  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: mode === 'development' ? '/' : 'https://josewesley2020.github.io/MakeupManager_v2/',
        scope: mode === 'development' ? '/' : 'https://josewesley2020.github.io/MakeupManager_v2/',
        id: mode === 'development' ? '/' : 'https://josewesley2020.github.io/MakeupManager_v2/',
        display: 'standalone',
